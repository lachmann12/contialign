...
pub fn index_stats(transcripts: &Vec<String>, eq_classes: &HashMap<u32, u32>, eq_elements: &HashMap<u32, Vec<u32>>, transcript_kmers: &HashMap<u32, u32>, kmer_length: &u32)  -> std::io::Result<()>{
